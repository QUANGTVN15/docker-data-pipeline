...
joketable = os.getenv("joketable.table", "jokedata")
...
JOKE_TABLE = os.environ.get("JOKE_TABLE") if os.environ.get("JOKE_TABLE") else 'jokedata'
...
def getDF(source_table):
    ...
    if source_table not in (WEATHER_TABLE, TWITTER_TABLE, FAKER_TABLE, JOKE_TABLE, joketable):
        return None
